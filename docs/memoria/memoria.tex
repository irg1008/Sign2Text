...
\begin{abstract}
  En la actualidad, no existe ningún traductor de lenguaje de signos a texto que funcione a tiempo real y sea capaz de traducir palabras complejas u oraciones largas. En este proyecto se busca usar un \loc{dataset} de personas realizando gestos y mapear los gestos a palabras individuales. Primero debemos preprocesar los datos de vídeo para adaptarlos a la entrada del modelo de \loc{deep learning}. Entonces entrenaremos el modelo y comprobaremos su rendimiento con ejemplos de test.
