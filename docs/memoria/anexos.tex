...
\begin{table}[p]
  \centering
  \begin{tabularx}{\linewidth}{p{0.20\columnwidth} p{0.80\columnwidth}}
    \toprule
    #3
    \otoprule
    \textbf{Autor} & \nombre \\
...
\newcommand{\titulo}{Sign2Text - Transcripción de lenguaje de signo mediante deep learning - Documentación técnica}
