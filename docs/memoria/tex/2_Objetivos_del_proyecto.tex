...
\begin{enumerate}
  \item Crear un modelo de \sigla{DL}\footnote{\textit{Deep Learning}} capaz de clasificar ASL\footnote{\textit{American Sign Language}} a nivel palabra.
  ...
  \item Aprender a fondo el uso de \prog{PyTorch}\bib{PYTORCH}, un \loc{framework} para acelerar la creación y prototipado de redes neuronales.
