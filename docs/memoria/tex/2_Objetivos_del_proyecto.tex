...
\begin{enumerate}
  \item Creación de un modelo de \sigla{DL}\footnote{\textit{Deep Learning}} capaz de clasificar ASL\footnote{\textit{American Sign Language}} a nivel palabra.
  \item Poner en producción un método para que los usuarios puedan probar el modelo de forma libre y transparante.
  \item Generar una \sigla{API} de código abierto para que otros desarrolladores puedan crear plataformas de cliente, con el objeto de aumentar la audencia y alcance del proyecto.
...
\subsection{\loc{Features} esperadas}
...
\begin{itemize}
  ...
  \item Se mantendrán unas estadísticas a tiempo real de la fase de \loc{trainning} y \loc{test} mediante el uso de \prog{Tensorboard}, una herramienta analítica que permite mantener un \loc{log} de imágenes generadas en la ejecución; así como gráficas de costes y \loc{accuracies}.
\end{itemize}
