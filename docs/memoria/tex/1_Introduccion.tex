...
Tras crear la red que transcriba el texto, se pretende crear una demo \loc{web} y \loc{API} para que cualquier usuario alrededor del mundo prueba probarlo. También se busca poder encapsular el modelo en un contenedor y dejarlo disponible para que cualquier desarrollador pueda descargarlo y crear su propia aplicación.
